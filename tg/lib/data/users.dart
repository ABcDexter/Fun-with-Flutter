...
void doPostData( String username,  String password) async{
  ...
  try {
    ...
    log_dev.log("Success body : ${parsedJson['username']}, ${parsedJson['role']} ${parsedJson['userInfo']['token']}", name: "doPostData");

    log_dev.log("Succes : $status | redirecting to Home Page", name: "doPostData"  );


  }
  catch (er){
    log_dev.log("Error : ${er.toString()} | Wont redirect", name: "doPostData"  );
...
final allUsers = <User>[
  const User(cycleNumber: '289189', desc: 'Week 15 - 5515', cycleStatus: '20', countDate: '04/15/2022', cycleStatusDesc: '20-printed', itemsToCount: 44),
  const User(cycleNumber: '289190', desc: 'Week 15 - 5885', cycleStatus: '21', countDate: '05/15/2022', cycleStatusDesc: '20-printed', itemsToCount: 60),
];
